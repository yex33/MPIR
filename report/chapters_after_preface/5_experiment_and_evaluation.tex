...
To assess the quality of the preconditioner, the nonlinear residual norm defined
...
Table~\ref{tab:res-accuracy} reports the relative forward and backward error for
