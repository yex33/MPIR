...
\item[\refstepcounter{acnum} \actheacnum \label{AC:precision}:] The floating point
...
\item[\refstepcounter{acnum} \actheacnum \label{AC:input}:] The format of the
  initial input data.
\item[\refstepcounter{acnum} \actheacnum \label{AC:output}:] The format of the
  final output data.
\item[\refstepcounter{acnum} \actheacnum \label{AC:example}:] How the example
...
\item [\refstepcounter{mnum} \mthemnum \label{M:factor}:] Matrix Factorization
  Module
\item [\refstepcounter{mnum} \mthemnum \label{M:ops}:] Mixed-precision Matrix
  Operations Module
\item [\refstepcounter{mnum} \mthemnum \label{M:solve}:] Iterative Solves Module
\item [\refstepcounter{mnum} \mthemnum \label{M:input}:] Read Matrix Module
\item [\refstepcounter{mnum} \mthemnum \label{M:output}:] Solver Output Module
\item [\refstepcounter{mnum} \mthemnum \label{M:example}:] Example Program Module
\end{description}
...
\begin{table}[h!]
  ...
  \begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
    ...
    \midrule
    \multirow{5}{0.3\textwidth}{Behaviour-Hiding Module}  & Read Matrix Module                       \\
                                                          & Solver Output Module                     \\
                                                          & Matrix Factorization Module              \\
                                                          & Mixed-precision Matrix Operations Module \\
...
\subsubsection{Mixed-precision Matrix Operations Factorization (\mref{M:ops})}

\begin{description}
\item[Secrets:] The structure of the input data
\item[Services:] Provides basic matrix operations such as multiplication, residual
  computation, element-wise operations at various floating point precision.
\item[Implemented By:] \progname{}
