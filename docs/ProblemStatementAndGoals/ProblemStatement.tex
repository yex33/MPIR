...
The challenge level of this project is expected to be advanced.

gain some preliminary knowledge and experience in relevant areas.

The underlaying method to solve this system would be GMRES which is not usually
taught in undergrad.
